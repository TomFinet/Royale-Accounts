...
DEFAULT_FILE_STORAGE = 'royaleaccounts.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'royaleaccounts.aws.utils.StaticRootS3BotoStorage'
AWS_STORAGE_BUCKET_NAME = 'royaleaccounts'
